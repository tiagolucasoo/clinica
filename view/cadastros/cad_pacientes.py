...
class Cad_Pacientes(ctk.CTkFrame):
    def __init__(self, parent, controller_instance):
        ...
        container_contato = ctk.CTkFrame(self, fg_color="transparent")
        container_contato.pack(side='top', pady=20)
        ...
        # CONTAINER - Renda Familiar e Cidade
        container_dados2 = ctk.CTkFrame(self, fg_color="transparent")
        container_dados2.pack(side='top', pady=20)

        container_renda = ctk.CTkFrame(container_dados2, fg_color="transparent")
        container_renda.pack(side='left', padx=10)
        ctk.CTkLabel(container_renda, text="Renda Familiar (R$)").pack()
        self.input_renda = ctk.CTkEntry(container_renda, placeholder_text="Ex: 8500.50", width=380, height=40, border_width=0)
        self.input_renda.pack()
    ...
    def salvar_dados_paciente(self):
        ...
        if self.controller.cadastrarPaciente(nome, nasc, email, telefone, cpf, renda, cidade, rua, numero, complemento):
