...
def DADOS_MEDICOS():
    ...
    dados = [
        ('João Gabriel da Silva', '22/03/1980', '123.456.789-00', 8000.00, 'Rua Rio de Janeiro', '100', 'ap 801', 1,1,),
        ('Maria Eduarda dos Santos', '29/03/1975', '987.654.321-00', 8500.00, 'Avenida Castelo Branco', '1200', None , 1,2,),
        ('Pedro Henrique de Oliveira', '05/04/1988', '111.222.333-44', 7500.00, 'Avenida Esperança', '300', 'Apto 101', 2, 3,),
        ('Ana Maria Costa', '12/04/1990', '555.666.777-88', 12000.00, 'Rua Augusta', '400', None, 3, 1,),
        ('Nathalia Duarte', '12/04/2001', '124.789.145-44', 3000.00, 'Rua Mercúrio', '124', None, 1, 3,),
        ('Tiago Lucas', '18/09/2001', '122.004.845-10', 4000.00, 'Rua Cabo Frio', '85', None, 1, 2,),
        ('Gregório Oliveira', '14/12/1997', '568.124.010-50', 2500.00, 'Rua Bandeirantes', '120', None, 2, 4,),
        ('Tom Hanks', '10/10/1989', '414.010.125-55', 6000.00, 'Avenida Paraná', '10B', None, 3, 5,),
        ('Jorge Sakamoto', '16/04/2004', '956.010.454-20', 8000.00, 'Avenida São João', '17C', None, 5, 8,),
        ('Hiro Nakaruma', '26/04/1978', '865.010.441-14', 11722.05, 'Rua Brigadeiro Correia de Melo', '1024', None, 5, 20,),
        ("Guilherme Ricardo", "05/05/1990", "099.105.051-00", 3000.00, "Rua Fernando de Souza", "20", "Centro comercial", 4, 5,),
        ("Maria Teles Fraga", "20/05/1985", "020.185.011-10", 3890.00, "Rua Jataizinho", "200", "Centro comercial", 2, 1,),
        ("Ana Liduário", "20/05/1970", "070.197.002-99", 4600.00, "Avenida da Liberdade", "1990", "Esquina", 6, 3,)]
...
def DADOS_PACIENTES_DOENCAS():
    ...
    dados = [
    (10, 1, '2023-12-15',), (12, 2, '2023-12-20',), (3, 3, '2023-12-27',),
    (4, 4, '2024-02-02',), (1, 10, '2024-02-05',), (3, 14, '2024-03-15',),
    (4, 13, '2024-03-20',), (2, 9, '2024-04-25',), (11, 5, '2024-06-03',),
    (6, 5, '2024-06-03',), (13, 10, '2024-06-04',), (2, 1, '2024-06-06',),
    (3, 1, '2024-07-25',), (4, 1, '2024-08-10',), (5, 1, '2024-09-02',),
    (1, 5, '2024-09-02',), (7, 10, '2024-11-19',), (1, 1, '2025-02-02',),
    (5, 5, '2025-02-11',), (2, 10, '2025-03-17',), (13, 5, '2025-03-23',),
    (12, 10, '2025-04-29',), (11, 5, '2025-05-02',), (10, 10, '2025-05-17',),
    (10, 1, '2024-07-25',), (11, 2, '2024-08-10',), (12, 2, '2024-09-02',),
    (13, 4, '2024-10-05',), (2, 4, '2024-11-19',), (5, 1, '2025-02-02',),
    (3, 5, '2025-02-11',), (4, 10, '2025-03-17',), (5, 5, '2025-03-23',),
    (6, 10, '2025-04-29',), (8, 2, '2025-05-02',), (9, 4, '2025-05-17',)]
